...
data_ip="https://raw.githubusercontent.com/MY-AnggA/Ga-Penting/main/ip"
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      \033[0;36mTelegram${NC} t.me/anggaalfarizi"
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/62xxx"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
checking_sc
clear
Repo1="https://raw.githubusercontent.com/MY-AnggA/izin/ip/"
...
END='\e[0m'
AKTIF="VERIFIED"
TOKEN="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"
...
TIMES="10"
CHATID="5196612474"
KEY="6878047280:AAGIMeNF8oSdQY6Cs7NgHbxjFVYmagJA78o"
